...
final class CreateEbSystemDictType extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        // Insert initial data
        $data = [
            ['id' => 1, 'name' => '数据表引擎', 'code' => 'table_engine', 'status' => 1, 'remark' => '数据表引擎字典'],
            ['id' => 2, 'name' => '存储模式', 'code' => 'upload_mode', 'status' => 1, 'remark' => '上传文件存储模式'],
            ['id' => 3, 'name' => '数据状态', 'code' => 'data_status', 'status' => 1, 'remark' => '通用数据状态'],
            ['id' => 4, 'name' => '后台首页', 'code' => 'dashboard', 'status' => 1],
            ['id' => 5, 'name' => '性别', 'code' => 'sex', 'status' => 1],
            ['id' => 6, 'name' => '消息类型', 'code' => 'queue_msg_type', 'status' => 1],
            ['id' => 7, 'name' => '后台公告类型', 'code' => 'backend_notice_type', 'status' => 1],
            ['id' => 8, 'name' => '请求方式', 'code' => 'request_mode', 'status' => 1],
            ['id' => 12, 'name' => '附件类型', 'code' => 'attachment_type', 'status' => 1],
        ];
